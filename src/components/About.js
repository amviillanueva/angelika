...
function About() {
    return(<Theme><Div className="d-flex align-content-center align-self-center justify-content-center flex-wrap flex-column mb-5 px-md-5">
        ...
        <H4 className="mt-4">RELEVANT EXPERIENCES</H4>
        {
            experiences.map(experience =>
                <AboutContent key={experience.id} title={experience.title} sub={experience.year} description={experience.details}/>
            )
        }
    </Div></Theme>)
}
